...
public class ObjectFactory {
    ...
    private final static QName _Echo_QNAME = new QName("http://control/", "Echo");
    private final static QName _EchoResponse_QNAME = new QName("http://control/", "EchoResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://control/", name = "Echo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://control/", name = "EchoResponse")
