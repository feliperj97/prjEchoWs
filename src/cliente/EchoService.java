 ...
 * 
 */
@WebServiceClient(name = "EchoService", targetNamespace = "http://control/", wsdlLocation = "http://localhost:10000/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVICE_QNAME = new QName("http://control/", "EchoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:10000/echo?wsdl");
    ...
    public Echo getEchoPort() {
        return super.getPort(new QName("http://control/", "EchoPort"), Echo.class);
    }
    ...
    public Echo getEchoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://control/", "EchoPort"), Echo.class, features);
    }
